...
- **Multi-library filter** — if your Navidrome exposes more than one library, the **Preferences › Media Library › Navidrome › Libraries** sub-page lets you restrict browsing/search to a chosen subset. Off by default (all libraries); the page is inert when the server only has one
